...
Para verificar a presença de efeitos ARCH, é feito um teste Ljung-Box nas séries de quadrados dos retornos das duas ações:
...
Box.test(sqr_1, lag=12, type="Ljung-Box")
...
Box.test(sqr_2, lag=12, type="Ljung-Box")
...
Como em ambos os casos o p-valor é menor do que 0.05, a hipótese nula é rejeitada. Há, portanto, **fortes indícios de efeitos ARCH**.
